...
namespace Mirror
{
    ...
    {
        public static NetworkRoomManager roomSingleton { get; internal set; }

        public static event UnityAction WhenRoomSlotsChange;
        public static event UnityAction WhenReadyStateChange;
